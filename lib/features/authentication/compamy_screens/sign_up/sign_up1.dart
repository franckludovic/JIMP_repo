...
class CompanySignUpScreen1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: JAppbar(title: Text('Basic Information', style:  Theme.of(context).textTheme.headlineMedium,), showBackArrow: true,),
            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  ...
                  expands: false,
                  decoration: const InputDecoration(
                      labelText: "Address line 1", prefixIcon: Icon(Iconsax.call)),
                ),
                ...
                TextFormField(
                  ...
                  expands: false,
                  decoration: const InputDecoration(
                      labelText: "Address line 2", prefixIcon: Icon(Iconsax.call)),
                ),
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Expanded(child: DocumentUploadWidget(title: 'Profile Picture', documentType: 'PNG, JPG')),
                        ...
                        Obx(
                            ...
                            items: employeeCounts.isEmpty ? ['Select an option'] : employeeCounts,
                            value: controller.companySize.value.isEmpty ? null : controller.companySize.value,
