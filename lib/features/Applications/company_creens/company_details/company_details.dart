...
import '../../screens/application_reviews/product_reviews.dart';
import '../company_profile/widget/company_specialisation.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar:  Padding(
        ...
        child: ElevatedButton(onPressed: () {}, child: Text("Save", style: TextStyle(fontSize: 20, fontFamily: "Poppins"),)),
      )
    );
  }
}
